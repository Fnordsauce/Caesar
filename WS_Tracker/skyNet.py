...
#Preparing the data Scalling the data dfown beween - and 1 
...
#Using the previous 90 days of data
prediction_days = 90
...
#Converitng into a numpy data array
...
print(f"The next day QQQ Price Prediction : {prediction}")
